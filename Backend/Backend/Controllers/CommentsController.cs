...
namespace Backend.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        [Produces(typeof(CommentDto))]
        public async Task<IActionResult> Post([Microsoft.AspNetCore.Mvc.FromBody]CommentDto comment, [FromQuery]int postId)
        {
        ...
        public async Task<IActionResult> Put(int id, [Microsoft.AspNetCore.Mvc.FromBody]CommentDto comment)
        {
